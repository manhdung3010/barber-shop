...
export default function ServicesSection() {
  ...
  return (
    <section
      ...
      className="bg-[#F4F0E8] text-[#0B0B0A] rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] py-24 sm:py-32 md:py-40 px-5 sm:px-8 md:px-10 lg:px-12 -mt-10 relative z-10 overflow-hidden"
    >
